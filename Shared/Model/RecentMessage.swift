...
var recentMsgs : [RecentMessage] = [
    ...
    RecentMessage( lastMsg: "Apple Tech", lastMsgTime: "15:00", pendingMsgs: "9", userName: "Jenna Ezarik", userImage: "IJustine", allMsgs: Eachmsg.shuffled()),
    RecentMessage(lastMsg: "New Album Is Going To Be Released!!!!", lastMsgTime: "14:32", pendingMsgs: "2", userName: "p8", userImage: "p0", allMsgs: Eachmsg.shuffled())
